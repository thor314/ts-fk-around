...
use crate::{k256_serde, SecretKey};
use k256::elliptic_curve::Field;
use serde::{Deserialize, Serialize};
use tofn::sdk::api::{TofnFatal, TofnResult};
use tracing::error;
use zeroize::Zeroize;
...
impl Vss {
    pub fn new(threshold: usize) -> Self {
        let secret_coeffs: Vec<SecretKey> = (0..=threshold)
    ...
    pub fn shares(&self, n: usize) -> Vec<Share> {
        ...
        (1..=n)
            .map(|index| {
                let index_scalar = k256::Scalar::from(index as u32); // vss indices start at 1
                Share {
